...
#
# Build container images for PIONUX OS.
#
...
readonly PIONUX_TAG="pionux-g$(git rev-parse --short HEAD)"
...
readonly ROOTFS_TAR="${OUT_DIR}/${PIONUX_TAG}-${OPT_NAME}-rootfs.tar.gz"
